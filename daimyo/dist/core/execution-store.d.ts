...
import type { DecisionId, DecisionRecord, ExecutionEvidence, NodeId, NodeStatus, NodeType, TaskId, ValidationReport } from "./domain.js";
...
export type ExecutionCursorReason = "scheduled" | "running" | "awaiting-decision" | "recovering";
...
export declare function workerRequiresRestart(node: ExecutionNodeState): boolean;
export declare function rebuildExecutionNodeTree(snapshot: ExecutionSnapshot): readonly ExecutionNodeTree[];
