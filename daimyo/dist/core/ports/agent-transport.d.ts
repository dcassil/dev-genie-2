...
export type AgentSessionId = string & {
    readonly __agentSessionId: unique symbol;
};
...
export type AgentTerminalReason = "completed" | "errored" | "interrupted" | "interrupt_timeout" | "closed";
...
export type AgentEvent = AgentTurnEndedEvent | AgentNeedsPermissionEvent | AgentNeedsInputEvent | AgentLogEvent | AgentExitedEvent | AgentStalledEvent;
...
export declare class AgentSessionResumeRejectedError extends Error {
    readonly sessionId: AgentSessionId;
...
export declare function asAgentSessionId(value: string): AgentSessionId;
export declare function asTransportCorrelationId(value: string): TransportCorrelationId;
